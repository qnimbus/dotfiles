...
# Temporarily disabled, not sure if we need this or if it causes more issues than it solves - can re-enable later with better error handling and maybe a less intrusive prompt
if (-not (Test-IsVSCode) -and $false) {
    try {
